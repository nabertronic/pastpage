...
const COPY: Record<CopyLocale, Copy> = {
  en: {
    ...
    moreFourBody: "Open every enabled archive in separate tabs when you want to check them manually.",
    customizeKicker: "",
    customizeTitle: "Adjust the details",
    customizeBody: "Choose how lookup results open, how the recovery bar looks, and which archives PastPage prioritizes.",
    openSettingsCta: "Open settings",
    footerNote: "Open source tool for searching archived versions of web pages.",
    rateOn: "Rate on {{browser}}",
    privacyLink: "Privacy"
  },
  de: {
    title: `Willkommen bei ${EXTENSION_NAME}`,
    description: "Finde archivierte Versionen von geänderten oder verschwundenen Webseiten.",
    pinKicker: "",
    pinTitle: "Symbol an die Toolbar pinnen",
    pinBody: "So ist „Aktuelle Seite nachschlagen“ immer nur einen Klick entfernt.",
    pinHint: "Sobald das Symbol angeheftet ist, kannst du jede Seite direkt prüfen.",
    stepLabel: "Schritt",
    pinStepsChromium: [
    ...
    moreOneBody: "Per Rechtsklick kannst du die aktuelle Seite in den Webarchiven suchen.",
    moreTwoTitle: "Linkziel im Archiv suchen",
    moreTwoBody: "Rechtsklicke auf einen Link, um in Archiven nach der Zielseite zu suchen, ohne sie zuerst zu öffnen.",
    ...
    moreFourBody: "Öffne alle aktivierten Archive in eigenen Tabs, wenn du sie manuell prüfen willst.",
    customizeKicker: "",
    customizeTitle: "Details anpassen",
    customizeBody: "Lege fest, wie Ergebnisse geöffnet werden, wie die Rettungsleiste aussieht und welche Archive priorisiert werden.",
    openSettingsCta: "Settings öffnen",
    footerNote: "Open-Source-Werkzeug, mit dem man archivierte Versionen von Webseiten suchen kann.",
  ...
  es: {
    ...
    moreFourBody: "Abre todos los archivos activados en pestañas separadas si quieres revisarlos manualmente.",
    customizeKicker: "",
    customizeTitle: "Ajusta los detalles",
    customizeBody: "Elige cómo se abren los resultados, cómo se ve la barra de recuperación y qué archivos prioriza PastPage.",
    openSettingsCta: "Abrir ajustes",
    footerNote: "Herramienta de código abierto para buscar versiones archivadas de páginas web.",
  ...
  fr: {
    ...
    moreFourBody: "Ouvrez toutes les archives activées dans des onglets séparés si vous voulez les vérifier manuellement.",
    customizeKicker: "",
    customizeTitle: "Réglez les détails",
    customizeBody: "Choisissez comment les résultats s'ouvrent, l'apparence de la barre de récupération et les archives que PastPage privilégie.",
    openSettingsCta: "Ouvrir les réglages",
    footerNote: "Outil open source pour rechercher des versions archivées de pages web.",
  ...
  it: {
    ...
    moreFourBody: "Apri tutti gli archivi attivati in schede separate se vuoi controllarli manualmente.",
    customizeKicker: "",
    customizeTitle: "Regola i dettagli",
    customizeBody: "Scegli come si aprono i risultati, come appare la barra di recupero e quali archivi PastPage deve privilegiare.",
    openSettingsCta: "Apri impostazioni",
    footerNote: "Strumento open source per cercare versioni archiviate di pagine web.",
  ...
  pl: {
    ...
    moreFourBody: "Otwórz wszystkie włączone archiwa w osobnych kartach, jeśli chcesz sprawdzić je ręcznie.",
    customizeKicker: "",
    customizeTitle: "Dopasuj szczegóły",
    customizeBody: "Ustaw, jak mają się otwierać wyniki, jak ma wyglądać pasek ratunkowy i które archiwa PastPage ma traktować priorytetowo.",
    openSettingsCta: "Otwórz ustawienia",
    footerNote: "Narzędzie open source do wyszukiwania archiwalnych wersji stron internetowych.",
  ...
  pt: {
    ...
    moreFourBody: "Abra todos os arquivos ativados em separadores próprios se quiser verificá-los manualmente.",
    customizeKicker: "",
    customizeTitle: "Ajustar detalhes",
    customizeBody: "Escolha como os resultados são abertos, como a barra de recuperação aparece e que arquivos o PastPage prioriza.",
    openSettingsCta: "Abrir definições",
    footerNote: "Ferramenta open source para procurar versões arquivadas de páginas web.",
  ...
  uk: {
    ...
    moreFourBody: "Відкрийте всі увімкнені архіви в окремих вкладках, якщо хочете перевірити їх вручну.",
    customizeKicker: "",
    customizeTitle: "Налаштувати деталі",
    customizeBody: "Виберіть, як відкривати результати, як має виглядати панель відновлення і які архіви PastPage має пріоритезувати.",
    openSettingsCta: "Відкрити налаштування",
    footerNote: "Інструмент open source для пошуку архівних версій вебсторінок.",
